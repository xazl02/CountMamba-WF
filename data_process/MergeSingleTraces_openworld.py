...
parser.add_argument("--input_dir", type=str, default="/nvme/dxw/TMWF-main/dataset/tbb single tab/")
parser.add_argument("--output_dir", type=str, default="/nvme/dxw/TMWF-main/dataset/tbb_multi_tab/")
